...
You have a persistent Persistent Agent Memory directory at `/mnt/c/Users/ronme/Documents/src/github.com/m3ssana/death-run/.claude/agent-memory/ux-game-designer/`. Its contents persist across conversations.
...
```
Grep with pattern="<search term>" path="/mnt/c/Users/ronme/Documents/src/github.com/m3ssana/death-run/.claude/agent-memory/ux-game-designer/" glob="*.md"
```
2. Session transcript logs (last resort — large files, slow):
```
Grep with pattern="<search term>" path="/home/ron/.claude/projects/-mnt-c-Users-ronme-Documents-src-github-com-m3ssana-death-run/" glob="*.jsonl"
```
